...
(* Calculemus`Gaussian` - DOMAIN PACK (Gaussian / extreme-value probability).
   A SEPARATE context, deliberately NOT loaded by the general Calculemus core.
...
BeginPackage["Calculemus`Gaussian`", {"Calculemus`", "NonCommutativeMultiply`"}];
